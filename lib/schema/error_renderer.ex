defmodule Schema.ErrorRenderer do
    @moduledoc """
    ...
    Result of `message` function appears in `Schema.errors` error tuple as last element, for those
    validators who use `Schema.Validator.ErrorMessage` (in general they should).
    ```
    """
