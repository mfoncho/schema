defmodule Schema.Validators.Number do
    @moduledoc """
    ...
    * `:allow_blank`: A boolean whether to skip this validaton for blank values.
    ...
    defp do_validate(_, :is, false) do 
        {:error, "must not be a number"}
    end
    
    defp do_validate(_, k, o) 
    when not is_number(o) do 
        raise("Invalid value #{inspect(o)} for option #{k}")
    end
    ...
    defp do_validate(_, :equal_to, o) do 
        {:error, "must be a number equal to #{o}"}
    end
    ...
    defp do_validate(_, :greater_than, o) do
        {:error, "must be a number greater than #{o}"}
    end
    ...
    defp do_validate(_, :greater_than_or_equal_to, o) do
        {:error, "must be a number greater than or equal to #{o}"}
    end
    ...
    defp do_validate(_, :less_than, o) do 
        {:error, "must be a number less than #{o}"}
    end
    ...
    defp do_validate(_, :less_than_or_equal_to, o) do
        {:error, "must be a number less than or equal to #{o}"}
    end
